...
# SSC JE Mechanical Engineering – Authentic Topper Strategies
...
### Core Advice
- **Start with basics:** Build strong concepts in Thermodynamics, SOM, TOM, and Fluids.
...
| 40 min    | Theory (1 subject, rotate daily)     | Thermo, SOM, TOM, Fluids     |
...
|-------|--------------------|--------------------|------------------------------|
| Mon   | Thermo (theory)    | Thermo (PYQs)      |                              |
| Tue   | SOM (theory)       | SOM (PYQs)         |                              |
| Wed   | TOM (theory)       | TOM (PYQs)         |                              |
| Thu   | Fluids (theory)    | Fluids (PYQs)      |                              |
| Fri   | Production/Materials| Mixed MCQs        |                              |
...
- **Interleaving:** Mix subjects in practice sets (e.g., 5 Thermo + 5 TOM + 5 Fluids).
...
### Core Advice
- **Focus on high-yield topics:** Thermo, SOM, TOM, Fluids, Production.
...
| Day   | AM Session         | PM Session         | Notes                        |
|-------|--------------------|--------------------|------------------------------|
| Mon   | Thermo (PYQs)      | SOM (theory)       |                              |
| Tue   | TOM (PYQs)         | Fluids (theory)    |                              |
| Wed   | Production (PYQs)  | Materials          |                              |
| Thu   | Heat Transfer      | Mixed MCQs         |                              |
...
- **Interleaving:** Daily mixed sets (e.g., 10 Thermo + 10 TOM + 10 Production).
...
- **Interleaving:**  
  ...
  - Example: 5 Thermo + 5 TOM + 5 Production in one set.
- **Reverse Learning:**  
